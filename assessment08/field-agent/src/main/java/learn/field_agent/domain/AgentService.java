...
public class AgentService {
    ...
    public AgentService(AgentRepository repository, AliasRepository aliases) {
        this.repository = repository;
        this.aliasRepository = aliases;
    }
    ...
    public Result<Agent> add(Agent agent) {
        ...
        agent.setAliases(aliasRepository.findAllByAgentId(agent.getAgentId()));
